...
export function runGame() {
    ...
    function Hero() {
        ...
        const torsoGeom = new THREE.CubeGeometry(7, 7, 10, 1);
        ...
        const pantsGeom = new THREE.CubeGeometry(9, 9, 5, 1);
        ...
        const cheekGeom = new THREE.CubeGeometry(1, 4, 4, 1);
        ...
        const noseGeom = new THREE.CubeGeometry(6, 6, 3, 1);
        ...
        const pawFGeom = new THREE.CubeGeometry(3, 3, 3, 1);
        ...
        const pawBGeom = new THREE.CubeGeometry(3, 3, 6, 1);
        ...
        const earGeom = new THREE.CubeGeometry(7, 18, 2, 1);
        ...
        const eyeGeom = new THREE.CubeGeometry(2, 4, 4);
        ...
        const irisGeom = new THREE.CubeGeometry(0.6, 2, 2);
    ...
    function BonusParticles() {
        this.mesh = new THREE.Group();
        const bigParticleGeom = new THREE.CubeGeometry(10, 10, 10, 1);
        const smallParticleGeom = new THREE.CubeGeometry(5, 5, 5, 1);
        this.parts = [];
    ...
    function Monster() {
        ...
        let eyeGeom = new THREE.CubeGeometry(2, 3, 3);
    ...
    Hedgehog.prototype.nod = function () {
        const that = this;
        const speed2 = 0.1 + Math.random() * 0.5;
        const angle = -Math.PI / 4 + (Math.random() * Math.PI) / 2;
        TweenMax.to(this.head.rotation, speed2, {
            y: angle,
            onComplete() {
                that.nod();
            }
    ...
    function Trunc() {
        ...
        for (let i = 0; i < geom.vertices.length; i += 1) {
            ...
            if (Math.random() > 0.7) {
                ...
                const fruitGeometry = new THREE.CubeGeometry(size, size, size, 1);
    ...
    function checkCollision() {
        const db = hero.mesh.position.clone().sub(carrot.mesh.position.clone());
